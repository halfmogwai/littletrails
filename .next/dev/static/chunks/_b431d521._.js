...
"[project]/components/three/EnhancedPlayerController.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
// Animation configuration with better transitions
const ANIMATION_CONFIG = {
    idle: {
        speed: 1.0,
        weight: 1.0,
        loop: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoopRepeat"]
    },
    walk: {
        speed: 1.5,
        weight: 1.0,
...
// Animation blending settings for smooth transitions
const ANIMATION_BLEND = {
    transitionSpeed: 8.0,
    fadeInDuration: 0.3,
    fadeOutDuration: 0.2,
    crossFade: true
};
function EnhancedPlayerController({ player, isLocalPlayer }) {
    _s();
    ...
    const updatePlayerPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stores$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "EnhancedPlayerController.useGameStore[updatePlayerPosition]": (state)=>state.updatePlayerPosition
    }["EnhancedPlayerController.useGameStore[updatePlayerPosition]"]);
    const updatePlayerAnimation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stores$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "EnhancedPlayerController.useGameStore[updatePlayerAnimation]": (state)=>state.updatePlayer
    }["EnhancedPlayerController.useGameStore[updatePlayerAnimation]"]);
    ...
    const [animationSpeed, setAnimationSpeed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(ANIMATION_CONFIG.idle.speed);
    ...
    const [lastAnimation, setLastAnimation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("idle");
    const [mixer, setMixer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Movement parameters
    ...
    // Determine which model to use based on player characteristics
    const modelPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EnhancedPlayerController.useMemo[modelPath]": ()=>{
            const { ageGroup } = player.character;
            const { gender, role } = player;
            if (role === "caregiver") {
                return `/models/${gender === "female" ? "female_caregiver" : "male_caregiver"}.glb`;
            }
            // For children, choose based on age and gender
            if (ageGroup === "1-4") {
                return `/models/${gender === "female" ? "little_girl" : "little_boy"}.glb`;
            } else {
                return `/models/${gender === "female" ? "base_child" : "base_toddler"}.glb`;
            }
        }
    }["EnhancedPlayerController.useMemo[modelPath]"], [
        player.gender,
        player.character.ageGroup,
        player.role
    ]);
    // Load the GLB model with error handling
    const { scene, animations } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Gltf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGLTF"])(modelPath);
    // Debug logging
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EnhancedPlayerController.useEffect": ()=>{
            console.log(`[EnhancedPlayerController] Loaded model: ${modelPath}`);
            console.log(`[EnhancedPlayerController] Animations found:`, animations.map({
                "EnhancedPlayerController.useEffect": (a)=>a.name
            }["EnhancedPlayerController.useEffect"]));
            console.log(`[EnhancedPlayerController] Scene has ${scene.children.length} children`);
        }
    }["EnhancedPlayerController.useEffect"], [
        scene,
        animations,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EnhancedPlayerController.useEffect": ()=>{
            if (groupRef.current && animations.length > 0) {
                const newMixer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimationMixer"](groupRef.current);
                setMixer(newMixer);
                return ({
                    "EnhancedPlayerController.useEffect": ()=>{
    ...
    // Animation state management with proper blending
    const setAnimationState = (newAnimation)=>{
        if (currentAnimation === newAnimation || !mixer) return;
        console.log(`[EnhancedPlayerController] Changing animation from ${currentAnimation} to ${newAnimation}`);
        setIsTransitioning(true);
        setLastAnimation(currentAnimation);
        setCurrentAnimation(newAnimation);
        setAnimationSpeed(ANIMATION_CONFIG[newAnimation].speed);
        // Update player store with new animation state
        updatePlayerAnimation(player.id, {
            currentAnimation: newAnimation
        });
        // Find animation clips
        const currentClip = animations.find((clip)=>clip.name.toLowerCase().includes(newAnimation));
        const lastClip = animations.find((clip)=>clip.name.toLowerCase().includes(lastAnimation));
        if (currentClip) {
            ...
            action.reset();
            action.setEffectiveTimeScale(ANIMATION_CONFIG[newAnimation].speed);
            action.setEffectiveWeight(ANIMATION_CONFIG[newAnimation].weight);
            action.play();
            // Crossfade from previous animation
            if (lastClip && ANIMATION_BLEND.crossFade) {
                const lastAction = mixer.clipAction(lastClip);
                lastAction.crossFadeTo(action, ANIMATION_BLEND.fadeInDuration, true);
            }
        }
        // Reset transition flag after fade duration
        setTimeout(()=>{
            setIsTransitioning(false);
        }, ANIMATION_BLEND.fadeInDuration * 1000);
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$1eccaf1c$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
        "EnhancedPlayerController.useFrame": (state, delta)=>{
            if (mixer) {
                mixer.update(delta * ANIMATION_BLEND.transitionSpeed);
            }
        }
    }["EnhancedPlayerController.useFrame"]);
    ...
    // Clone the scene for this instance and ensure materials are properly configured
    const clonedScene = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EnhancedPlayerController.useMemo[clonedScene]": ()=>{
            const cloned = scene.clone(true);
            cloned.updateMatrixWorld(true);
            cloned.traverse({
                "EnhancedPlayerController.useMemo[clonedScene]": (child)=>{
                    if (child.isMesh) {
                        child.frustumCulled = false; // <-- big one
                        // Ensure bounds exist
                        if (child.geometry) {
                            child.geometry.computeBoundingBox?.();
                            child.geometry.computeBoundingSphere?.();
                        }
                        // Don’t force FrontSide unless you KNOW normals are correct
                        const setMat = {
                            "EnhancedPlayerController.useMemo[clonedScene].setMat": (mat)=>{
                                mat.transparent = false;
                                mat.opacity = 1;
                                mat.depthWrite = true;
                                mat.depthTest = true;
                                mat.side = 2; // DoubleSide (debug). Switch back later if you want.
                                mat.needsUpdate = true;
                            }
                        }["EnhancedPlayerController.useMemo[clonedScene].setMat"];
                        if (Array.isArray(child.material)) child.material.forEach(setMat);
                        else if (child.material) setMat(child.material);
                    }
                }
            }["EnhancedPlayerController.useMemo[clonedScene]"]);
            return cloned;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$rapier$2f$dist$2f$react$2d$three$2d$rapier$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["RigidBody"], {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$rapier$2f$dist$2f$react$2d$three$2d$rapier$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CapsuleCollider"], {
                ...
                fileName: "[project]/components/three/EnhancedPlayerController.tsx",
                lineNumber: 337,
                columnNumber: 7
            }, this),
...
_s(EnhancedPlayerController, "nJN+V0PN4Vuz6lrOnYLyRUFszRo=", false, function() {
    return [
...
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Gltf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGLTF"].preload("/models/little_boy.glb");
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Gltf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGLTF"].preload("/models/little_girl.glb");
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Gltf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGLTF"].preload("/models/base_child.glb");
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Gltf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGLTF"].preload("/models/base_toddler.glb");
...
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "EnhancedPlayerController");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stores$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/stores/gameStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$three$2f$EnhancedPlayerController$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/three/EnhancedPlayerController.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$web$2f$KeyboardControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@react-three/drei/web/KeyboardControls.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function PlayerCharacters() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$web$2f$KeyboardControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KeyboardControls"], {
        map: keyboardMap,
        children: players.map((player)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$three$2f$EnhancedPlayerController$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EnhancedPlayerController"], {
                player: player,
            ...
            cloned.traverse({
                "EnhancedCaregiverModel.useMemo[clonedScene]": (child)=>{
                    if (child.isMesh) {
                        ...
                        // Don’t force FrontSide unless you KNOW normals are correct
                        const setMat = {
                            "EnhancedCaregiverModel.useMemo[clonedScene].setMat": (mat)=>{
                                mat.transparent = false;
                                mat.opacity = 1;
                                mat.depthWrite = true;
                                mat.depthTest = true;
                        ...
                        }["EnhancedCaregiverModel.useMemo[clonedScene].setMat"];
                        if (Array.isArray(child.material)) child.material.forEach(setMat);
                        else if (child.material) setMat(child.material);
                    }
                }
...
//# sourceMappingURL=_b431d521._.js.map